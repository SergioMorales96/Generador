...
public class ArchivoService implements IArchivoService {
	...
	public ResponseDTO getAll() {
		...
		return new ResponseDTO( mapperArchivo.listEntityToDto( archivoRepository.findAll()), true, "ok", HttpStatus.OK);
	}
	...
	public ResponseDTO buscarPorId(Integer id) {
		...
		return new ResponseDTO(archivoEntity.get(), true, "ok", HttpStatus.OK);
	}
	...
	public ResponseDTO consultarTodosCreador(Integer usuarioCreador) {
		...
		// List<ArchivoDTO> lisArchivoDTOs = mapperArchivo.listentityToDto(archivoRepository.queryUsuarioCreador(usuarioCreador));
