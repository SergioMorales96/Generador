...
public class UsuarioService implements IUsuarioService{
	...
	private Object generarToken(String username) {

		List<GrantedAuthority> permisos = AuthorityUtils.commaSeparatedStringToAuthorityList("ROLE USER");

		String token = Jwts.builder().setId("softtekJWT").setSubject(username).claim("authorities", permisos.stream()
